from flet import* 
from components.Graficos import GraficoLinhas, path_csv, path_json
    ...
    content=Row(
        ...
        controls=[
            Container(
                content=Row(
                    controls=[
                        Icon(icons.SQUARE, color="#00D154", size=13),
                        Text(value = "Maior variância - " + maior_variancia_temperatura, color="#000000", size=14, weight=FontWeight.W_500),
                    ],
                ),
            ),
            Container(
                content=Row(
                    controls=[
                        Icon(icons.SQUARE, color="#00D154", size=13),
                        Text(value=" Variância média - " + media_variancia_temperatura, color="#000000", size=14, weight=FontWeight.W_500),
                    ],
                ),
            ),
            Container(
                content=Row(
                    controls=[
                        Icon(icons.SQUARE, color="#00D154", size=13),
                        Text(value=" Média de assertividade - " + str(assertividade_temperatura), color="#000000", size=14, weight=FontWeight.W_500,),
                    ],
                ),
            ),
